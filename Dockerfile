# ─────────────────────────────────────────────────────────────────────────────
# Bulgarian Cybersecurity MCP — multi-stage Dockerfile
# ─────────────────────────────────────────────────────────────────────────────
# Build:  docker build -t bulgarian-cybersecurity-mcp .
# Run:    docker run --rm -p 3000:3000 bulgarian-cybersecurity-mcp
#
# The image expects a pre-built database at /app/data/cert-bg.db.
# Override with CERT_BG_DB_PATH for a custom location.
#
...
ENV CERT_BG_DB_PATH=/app/data/cert-bg.db
...
COPY data/database.db data/cert-bg.db
