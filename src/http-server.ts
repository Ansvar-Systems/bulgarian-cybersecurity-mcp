...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across CERT-BG cybersecurity guidelines, recommendations, and national standards. Covers network security, incident response, risk management, and NIS2 implementation guidance.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'мрежова сигурност', 'NIS2', 'киберсигурност')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "CERT-BG document reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search CERT-BG security advisories and alerts. Returns advisories with severity, affected products, and CVE references.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'критична уязвимост', 'рансъмуер')" },
        severity: {
          type: "string",
  ...
  },
  {
    ...
    description: "Get a specific CERT-BG security advisory by reference (e.g., 'CERT-BG-A-2024-001').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "CERT-BG advisory reference" },
      },
      required: ["reference"],
    },
  },
      ...
      switch (name) {
        ...
        case "bg_cyber_about": {
          return textContent({
            ...
            data_source: "CERT-BG (https://www.govcert.bg/) and DANS (https://www.dans.bg/)",
