/**
 * SQLite database access layer for the Bulgarian Cybersecurity (CERT-BG) MCP server.
 *
 * Schema:
 *   - guidance    — CERT-BG guidelines, recommendations, and national cybersecurity standards
